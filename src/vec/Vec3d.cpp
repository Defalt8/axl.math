...
Vec3d Vec3d::cross(const Vec3d& vec, Rules::Axis axis_rule) const
{
	...
	{
		default:
		case Rules::Axis::RHS: return Vec3d((y * vec.z - z * vec.y), (z * vec.x - x * vec.z), (x * vec.y - y * vec.x));
		case Rules::Axis::LHS: return Vec3d((z * vec.y - y * vec.z), (x * vec.z - z * vec.x), (y * vec.x - x * vec.y));
	}
}
Vec3d Vec3d::euler(Rules::Axis axis_rule) const
{
	...
	{
		default:
		case Rules::Axis::RHS: return Vec3d(std::atan2(z, y), std::atan2(x, z), std::atan2(y, x));
		case Rules::Axis::LHS: return Vec3d(std::atan2(y, z), std::atan2(z, x), std::atan2(x, y));
	}
}
Vec3d Vec3d::euler(const Vec3d& ref_vec, Rules::Axis axis_rule) const
{
	...
	{
		default:
		case Rules::Axis::RHS: return Vec3d(std::atan2(z, y) - std::atan2(ref_vec.z, ref_vec.y), std::atan2(x, z) - std::atan2(ref_vec.x, ref_vec.z), std::atan2(y, x) - std::atan2(ref_vec.y, ref_vec.x));
		case Rules::Axis::LHS: return Vec3d(std::atan2(y, z) - std::atan2(ref_vec.y, ref_vec.z), std::atan2(z, x) - std::atan2(ref_vec.z, ref_vec.x), std::atan2(x, y) - std::atan2(ref_vec.x, ref_vec.y));
	}
}
...
Rules::Axis Vec3d::DefaultAxisRule = Rules::Axis::RHS;
