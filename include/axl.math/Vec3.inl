...
template <typename T>
template <typename U>
Vec3<T>::Vec3(const Vec2<U>& vec, T _z) :
...
template <typename T>
bool Vec3<T>::operator==(const T& v) const 
{
	return (x == v && y == v && z == v);
}
template <typename T>
...
template <typename T>
template <typename U>
bool Vec3<T>::equals(const Vec3<U>& vec) const
{
	return (x == vec.x && y == vec.y && z == vec.z);
}
template <typename T>
template <typename U>
bool Vec3<T>::notEquals(const Vec3<U>& vec) const
{
	return (x != vec.x || y != vec.y || z != vec.z);
}
template <typename T>
template <typename U>
bool Vec3<T>::equals(U _x, U _y, U _z) const
{
	return (x == _x && y == _y && z == _z);
}
template <typename T>
template <typename U>
bool Vec3<T>::notEquals(U _x, U _y, U _z) const
{
	return (x != _x || y != _y || z != _z);
}

template <typename T>
Vec3<T>& Vec3<T>::set(T value) 
{
	this->x = (value); this->y = (value); this->z = (value); return *this;
}
template <typename T>
Vec3<T>& Vec3<T>::set(T _x, T _y) 
{
...
template <typename T>
Vec3<T> operator+(T v, const Vec3<T>& vec)
{
