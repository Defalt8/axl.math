...
int main(int argc, char *argv[])
{
	...
	{ // static values
		...
		Assertv(Vec3f::filled(69.96f).equals(69.96f, 69.96f, 69.96f), verbose);
	...
	{ // vector operations
		...
		{ // euler angle
			Vec3f::DefaultAxisRule = Rules::Axis::RHS;
			Assertve(Vec3f::DefaultAxisRule == Rules::Axis::RHS, verbose);
			{ // RHS
			...
			Vec3f::DefaultAxisRule = Rules::Axis::LHS;
			Assertve(Vec3f::DefaultAxisRule == Rules::Axis::LHS, verbose);
			{ // LHS
				Assertv(Vec3f(0, 0, 0).euler().equals(0.0f, 0.0f, 0.0f, 0.0001f), verbose);
