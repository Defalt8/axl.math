...
int main(int argc, char *argv[])
{
	...
	{ // vector operations
		...
		{ // euler angle
			Vec3d::DefaultAxisRule = Rules::Axis::RHS;
			Assertve(Vec3d::DefaultAxisRule == Rules::Axis::RHS, verbose);
			{ // RHS
			...
			Vec3d::DefaultAxisRule = Rules::Axis::LHS;
			Assertve(Vec3d::DefaultAxisRule == Rules::Axis::LHS, verbose);
			{ // LHS
				Assertv(Vec3d(0, 0, 0).euler().equals(0.0, 0.0, 0.0), verbose);
