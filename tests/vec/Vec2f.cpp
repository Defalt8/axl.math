...
int main(int argc, char *argv[])
{
	...
	{ // vector operations
		...
		{ // angle
			Assertve(Vec2f::DefaultAxisRule == Rules::Axis::RHS, verbose);
			{ // Rules::Axis::RHS
			...
			{ // Rules::Axis::LHS
				Vec2f::DefaultAxisRule = Rules::Axis::LHS;
				Assertve(Vec2f::DefaultAxisRule == Rules::Axis::LHS, verbose);
				Assertv(Float::equals(Vec2f(-0.0f, 0.0f).angle(), Angle::degToRad(-0.0f), 0.0001f), verbose);
				Assertv(Float::equals(Vec2f(0.0f, -0.0f).angle(), Angle::degToRad(180.0f), 0.0001f), verbose);
				Assertv(Float::equals(Vec2f(-0.0f, -0.0f).angle(), Angle::degToRad(-180.0f), 0.0001f), verbose);
				Assertv(Float::equals(Vec2f(0.0f, 0.0f).angle(), Angle::degToRad(0.0f), 0.0001f), verbose);
			...
			{ // Rules::Axis::RHS
				Vec2f::DefaultAxisRule = Rules::Axis::RHS;
				Assertve(Vec2f::DefaultAxisRule == Rules::Axis::RHS, verbose);
